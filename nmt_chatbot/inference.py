...
from nmt_chatbot.nmt.nmt import nmt
import argparse
from nmt_chatbot.setup.settings import hparams, out_dir, preprocessing, score as score_settings
sys.path.remove(os.path.realpath(os.path.dirname(__file__)) + "/setup")
import tensorflow as tf
from nmt_chatbot.core.tokenizer import tokenize, detokenize, apply_bpe, apply_bpe_load
from nmt_chatbot.core.sentence import replace_in_answers, normalize_new_lines
from nmt_chatbot.core.scorer import score_answers
